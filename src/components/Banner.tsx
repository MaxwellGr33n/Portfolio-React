            ...
            <div className="hidden lg:flex lg:gap-x-6 lg:pr-4">
              {navigation.map((item) => (
                <Link
                  ...
                  offset={50}
                  duration={500}
                  className="text-sm font-semibold cursor-pointer leading-6 px-4 py- rounded-full text-gray-900 bg-white hover:bg-neutral-50 dark:text-neutral-50 dark:bg-gray-800 dark:hover:bg-gray-900 hover:shadow-md focus:shadow-md"
